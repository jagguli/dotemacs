...
(req-package xcscope
  ...
  (progn
    ...
    (defun cscope-mappings()
      ...
      (evil-define-key 'normal evil-normal-state-map "C-c d"
        'cscope-find-symbol)
      (evil-define-key 'normal evil-normal-state-map "C-c t"
        'cscope-find-global-definition-no-prompting)
      (define-key evil-normal-state-map (kbd "C-c t") 'cscope-pop-mark)
      (evil-declare-key 'motion cscope-list-entry-keymap (kbd "<return>")
        'cscope-select-entry-other-window)
      (evil-declare-key 'motion cscope-list-entry-keymap (kbd "RET")
        'cscope-select-entry-other-window))
