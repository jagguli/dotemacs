...
(custom-set-variables
 ...
 '(jabber-alert-message-hooks (quote (jabber-message-display jabber-message-echo jabber-message-wave jabber-message-libnotify)) t)
...
(custom-set-faces
 ...
 '(flycheck-error ((t (:underline (:color "red" :style wave)))) t)
